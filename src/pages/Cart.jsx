            ...
            <>
                  ...
                  {cart.map(({ product, quantity }) => (
                    <tr key={product._id}>
                      ...
                      <td className="text-center">
                        <InputGroup size="sm" style={{ maxWidth: 110, margin: "0 auto" }}>
                          <Button variant="outline-secondary" size="sm" disabled={updating || quantity <= 1}
                          ...
                          <FormControl
                            ...
                            style={{ width: 42 }}
                          />
                          <Button variant="outline-secondary" size="sm" disabled={updating}
                            onClick={() => handleQuantityChange(product._id, quantity + 1)}>
                            <i className="bi bi-plus"></i>
                          </Button>
                        </InputGroup>
                      </td>
                      <td className="text-center fw-semibold">{product.price * quantity} TND</td>
                      <td className="text-center">
              ...
              <Row>
                <Col xs={12} md={6} className="ms-auto">
                  ...
                  <Button className="mt-3 w-100" size="lg" variant="success" disabled={updating || cart.length === 0} onClick={handleCheckout}>
